  ...
  return (
    <div className="p-2 sm:p-6 w-full max-w-full overflow-hidden">
      <div className="mb-3 sm:mb-6">
        ...
        <p className="text-muted-foreground text-sm sm:text-base">Browse all the images you&apos;ve saved to your favorites</p>
      </div>
      ...
      {loading ? (
        ...
        >
          ...
          <p className="text-muted-foreground text-base sm:text-lg mb-1 sm:mb-2 text-center px-4">No favorites found</p>
          <p className="text-muted-foreground/70 mb-4 sm:mb-6 text-sm sm:text-base text-center px-4">You haven&apos;t added any images to your favorites in this category yet</p>
          <Link href="/feed">
